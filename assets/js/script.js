$(document).ready(function () {
	...
	$("#search-button").on("click", function () {
		...
		$("#city-name").val("");// clear input box =after hitting search
		$("input:text").click(function () { // clear input box when clicking inside box
			$(this).val("");
	...
	function getWeather(cityName) {
		$.ajax({
			...
			success: function (data) {
				...
				$("#todays-weather").append(forecastUl); //merge and add to heml
	...
	function getUVIndexWarning(lat, lon) {
		$.ajax({
			...
			success: function (data) {
				...
				$("#todays-weather #index-div").append(uvText.append(btn)); //append btn and add to #index-div
			},
		});
	}
